...
This tool allows veterans to easily input individual condition ratings and compute their official VA  
combined disability rating, following actual VA math rules.
